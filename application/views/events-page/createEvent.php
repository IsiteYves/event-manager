...
<body>
	...
	<div class="container">
		<h4 class="panel-heading my-3">Register an Event</h4>
		<div class="panel-body">
			...
			<form method="post" action="<?php echo base_url(); ?>createEvent/validation" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input class="form-control" type="datetime-local" value="<?php echo set_value('event_duration') ?>" name="event_duration" min="<?php $datetime = new DateTime('tomorrow');
